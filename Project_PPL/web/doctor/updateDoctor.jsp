...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            con.open("ppl","3306");
            Doctor doctor = con.getDoctorById(id);
            con.close();
            %>
            <form class="form-horizontal" action='../DoctorServlet' method="POST">
                <fieldset>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="firstName" placeholder="" tabindex="2" 
                                   class="form-control" value="<%=doctor.getFirstName() %>">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="lastName" placeholder="" tabindex="2" 
                                   class="form-control" value="<%=doctor.getLastName() %>">
                            <p class="help-block">Username can contain any letters or numbers, without spaces</p>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <input class="radio-inline" type="radio" name="gender" value="Female" checked style="margin-left:20px">Female
                        <% } %>
                    </div>
                    <div class="control-group">
                        <!-- Password -->
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text"  name="specific" placeholder="" tabindex="2"
                                   class="form-control" value="<%=doctor.getSpec() %>">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <input type="submit" class="btn btn-success" name='action' value='Update Doctor'>
                        </div>
                    </div>
                </fieldset>
            </form>
