<%-- 
    Document   : admin
    Created on : Apr 25, 2018, 8:53:55 AM
    Author     : PC
--%>
...
<html>
    <head>
        ...
        <!-- Ionicons -->
        <link href="../vendor/ionicons.min.css" rel="stylesheet" type="text/css"/>
        <!-- Theme style -->
        <link href="../vendor/adminlte.min.css" rel="stylesheet" type="text/css"/>
        <!-- iCheck -->
        <link href="../vendor/blue.css" rel="stylesheet" type="text/css"/>
        <!-- Morris chart -->
        <link href="../vendor/morris.css" rel="stylesheet" type="text/css"/>
        <!-- jvectormap -->
        <link href="../vendor/jquery-jvectormap-1.2.2.css" rel="stylesheet" type="text/css"/>
        <!-- Date Picker -->
        <link href="../vendor/datepicker3.css" rel="stylesheet" type="text/css"/>
        <!-- Daterange picker -->
        <link href="../vendor/daterangepicker-bs3.css" rel="stylesheet" type="text/css"/>
        <!-- bootstrap wysihtml5 - text editor -->
        <link href="../vendor/bootstrap3-wysihtml5.min.css" rel="stylesheet" type="text/css"/>
    ...
    <body class="hold-transition sidebar-mini">
        ...
        <!-- Bootstrap 4 -->
        <script src="../vendor/bootstrap.bundle.min.js" type="text/javascript"></script>
        <!-- Morris.js charts -->
        <script src="../vendor/raphael-min.js" type="text/javascript"></script>
        <script src="../vendor/morris.min.js" type="text/javascript"></script>
        <!-- Sparkline -->
        <script src="../vendor/jquery.sparkline.min.js" type="text/javascript"></script>
        <!-- jvectormap -->
        <script src="../vendor/jquery-jvectormap-1.2.2.min.js" type="text/javascript"></script>
        <script src="../vendor/jquery-jvectormap-world-mill-en.js" type="text/javascript"></script>
        <!-- jQuery Knob Chart -->
        <script src="../vendor/jquery.knob.js" type="text/javascript"></script>
        <!-- daterangepicker -->
        <script src="../vendor/moment.min.js" type="text/javascript"></script>
        <script src="../vendor/daterangepicker.js" type="text/javascript"></script>
        <!-- datepicker -->
        <script src="../vendor/bootstrap-datepicker.js" type="text/javascript"></script>
        <!-- Bootstrap WYSIHTML5 -->
        <script src="../vendor/bootstrap3-wysihtml5.all.min.js" type="text/javascript"></script>
        <!-- Slimscroll -->
        <script src="../vendor/jquery.slimscroll.min.js" type="text/javascript"></script>
        <!-- FastClick -->
        <script src="../vendor/fastclick.js" type="text/javascript"></script>
        <!-- AdminLTE App -->
        <script src="../vendor/adminlte.js" type="text/javascript"></script>
        <!-- AdminLTE dashboard demo (This is only for demo purposes) -->
        <script src="../vendor/dashboard.js" type="text/javascript"></script>
        <!-- AdminLTE for demo purposes -->
        <script src="../vendor/demo.js" type="text/javascript"></script>
                        ...
                        <form class="form-horizontal" action="../UserServlet" method="GET">
                            <fieldset>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="FirstName" placeholder="" tabindex="2" class="form-control" required>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text"  name="LastName" placeholder="" tabindex="2" class="form-control" required>
                                        <p class="help-block">Username can contain any letters or numbers, without spaces</p>
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text"  name="Email" placeholder="" tabindex="2" class="form-control" required>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="password"  name="Password" placeholder="" tabindex="2" class="form-control" required>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="password"  name="ConfirmPassword" placeholder="" tabindex="2" class="form-control" required>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text"  name="Phone" placeholder="" tabindex="2" class="form-control" required>
                                    </div>
                                </div>
                                <div class="control-group">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="file" name="Avatar" placeholder="" tabindex="2" class="form-control" >
                                    </div>
                                </div>
