...
<html>
    ...
    <body>
            ...
            <div class="col-sm-6 col-sm-push-3 resetpass">
                <form id="changePassPatient" action="./UserServlet" method="post" role="form" style="display: block;">
                    <div class="form-group">
                        <label for="remember"> Please provide your email address to reset your address</label>
                        <input type="email" class="form-control"  placeholder="Your Email Address" name="Email" id="changeEmail" required>
                        <input type="hidden" name="table" value="patient"/>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            <div class="col-sm-6 col-sm-offset-3">
                                <input type="submit" name="action" id="login-submit" tabindex="4" class="form-control btn btn-success" value="Change Password Patient">
                            </div>
                        </div>
                    </div>
                </form>
